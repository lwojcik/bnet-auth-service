...
const createServer = async (params: TestServerParams) => {
...
const startServer = async (app: NestFastifyApplication) => {
  await app.init();
  await app.getHttpAdapter().getInstance().ready();
};

const stopServer = async (app: NestFastifyApplication) => {
  await app.close();
};
...
interface TestEndpointParams extends TestParams {
